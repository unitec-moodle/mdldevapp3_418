...
if ($ADMIN->fulltree) {
    ...
    $setting = new admin_setting_configtext('theme_boost_comp_it/unaddableblocks',
        get_string('unaddableblocks', 'theme_boost_comp_it'), get_string('unaddableblocks_desc', 'theme_boost_comp_it'), $default, PARAM_TEXT);
    $page->add($setting);
    ...
    $name = 'theme_boost_comp_it/loginbackgroundimage';
    $title = get_string('loginbackgroundimage', 'theme_boost_comp_it');
    $description = get_string('loginbackgroundimage_desc', 'theme_boost_comp_it');
