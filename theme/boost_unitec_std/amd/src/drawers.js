 ...
 *
 * @module     theme_boost_unitec_std/drawers
 ...
 * {@link module:theme_boost_unitec_std/drawers#eventTypes eventTypes} object.
 *
 * @example <caption>Standard usage</caption>
 *
 * // The module just needs to be included to add drawer support.
 * import 'theme_boost_unitec_std/drawers';
 *
 * @example <caption>Manually open or close any drawer</caption>
 *
 * import Drawers from 'theme_boost_unitec_std/drawers';
 *
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_boost_unitec_std/drawers:show}
     * @property {String} drawerShown See {@link event:theme_boost_unitec_std/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_boost_unitec_std/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_boost_unitec_std/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_boost_unitec_std/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_boost_unitec_std/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_boost_unitec_std/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_boost_unitec_std/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_boost_unitec_std/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_boost_unitec_std/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_boost_unitec_std/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_boost_unitec_std/drawers:hidden',
    };
     ...
     * @returns {module:theme_boost_unitec_std/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_boost_unitec_std/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_boost_unitec_std/drawers:close');
     ...
     *
     * @param {module:theme_boost_unitec_std/drawers} comparisonInstance
     */
