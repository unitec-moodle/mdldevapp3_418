...
$string['choosereadme'] = 'Boost Unitec Standard is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['configtitle'] = 'Boost Unitec Standard';
$string['generalsettings'] = 'General settings';
$string['loginbackgroundimage'] = 'Login page background image';
$string['loginbackgroundimage_desc'] = 'The image to display as a background for the login page.';
$string['nobootswatch'] = 'None';
$string['pluginname'] = 'Boost Unitec Standard';
...
$string['privacy:metadata'] = 'The Boost Unitec Standard theme does not store any personal data about any user.';
