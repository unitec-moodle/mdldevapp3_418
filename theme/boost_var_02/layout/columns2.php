...
$upperfullwidthtml = $OUTPUT->blocks('upper-fullwidth');
$hasupperfullwidth = strpos($upperfullwidthtml, 'data-block=') !== false;
$lowerfullwidthtml = $OUTPUT->blocks('lower-fullwidth');
$haslowerfullwidth = strpos($lowerfullwidthtml, 'data-block=') !== false;
...
echo $OUTPUT->render_from_template('theme_boost_var_02/columns2', $templatecontext);
