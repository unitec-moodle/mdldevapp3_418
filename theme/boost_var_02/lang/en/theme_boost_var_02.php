...
$string['choosereadme'] = 'Boost Var 02 is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['configtitle'] = 'Boost Var 02';
$string['generalsettings'] = 'General settings';
$string['loginbackgroundimage'] = 'Login page background image';
$string['loginbackgroundimage_desc'] = 'The image to display as a background for the login page.';
$string['nobootswatch'] = 'None';
$string['pluginname'] = 'Boost Var 02';
...
$string['privacy:metadata'] = 'The Boost Var 02 theme does not store any personal data about any user.';
...
//Top block region
$string['region-top-fullwidth'] = 'Below Navbar';
//Top block region
