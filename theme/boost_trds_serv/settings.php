...
if ($ADMIN->fulltree) {
    ...
    $setting = new admin_setting_configtext('theme_boost_trds_serv/unaddableblocks',
        get_string('unaddableblocks', 'theme_boost_trds_serv'), get_string('unaddableblocks_desc', 'theme_boost_trds_serv'), $default, PARAM_TEXT);
    $page->add($setting);
    ...
    $name = 'theme_boost_trds_serv/loginbackgroundimage';
    $title = get_string('loginbackgroundimage', 'theme_boost_trds_serv');
    $description = get_string('loginbackgroundimage_desc', 'theme_boost_trds_serv');
