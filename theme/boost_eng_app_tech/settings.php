...
if ($ADMIN->fulltree) {
    ...
    $setting = new admin_setting_configtext('theme_boost_eng_app_tech/unaddableblocks',
        get_string('unaddableblocks', 'theme_boost_eng_app_tech'), get_string('unaddableblocks_desc', 'theme_boost_eng_app_tech'), $default, PARAM_TEXT);
    $page->add($setting);
    ...
    $name = 'theme_boost_eng_app_tech/loginbackgroundimage';
    $title = get_string('loginbackgroundimage', 'theme_boost_eng_app_tech');
    $description = get_string('loginbackgroundimage_desc', 'theme_boost_eng_app_tech');
