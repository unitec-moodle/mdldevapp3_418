 ...
 *
 * @module     theme_boost_crtv_ind/drawers
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_boost_crtv_ind/drawers:show}
     * @property {String} drawerShown See {@link event:theme_boost_crtv_ind/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_boost_crtv_ind/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_boost_crtv_ind/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_boost_crtv_ind/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_boost_crtv_ind/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_boost_crtv_ind/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_boost_crtv_ind/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_boost_crtv_ind/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_boost_crtv_ind/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_boost_crtv_ind/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_boost_crtv_ind/drawers:hidden',
    };
     ...
     * @returns {module:theme_boost_crtv_ind/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_boost_crtv_ind/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_boost_crtv_ind/drawers:close');
     ...
     *
     * @param {module:theme_boost_crtv_ind/drawers} comparisonInstance
     */
